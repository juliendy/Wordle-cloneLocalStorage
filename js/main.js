document.addEventListener("DOMContentLoaded", () => {
    ...
    function loadLocalStorage() {
        ...
        guessedWordCount =
            ...
            guessedWordCount;
        availableSpace =
            Number(window.localStorage.getItem("availableSpace")) ||
            availableSpace;
        guessedWords =
            JSON.parse(window.localStorage.getItem("guessedWords")) ||
            guessedWords;

        currentWord = words[currentWordIndex];

        const storedBoardContainer =
            window.localStorage.getItem("boardContainer");
            ...
            currentWordArr.forEach((letter, index) => {
                setTimeout(() => {
                    ...
                    if (tileClass) {
                        ...
                        const keyboardEl = document.querySelector(
                            `[data-key=${letter}]`
                        );
